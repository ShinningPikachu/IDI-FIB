...
class LL2GLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  protected:
    ...
    // {Rick/Morty/Portal/ident}Transform - Funciones per construir i enviar al shader diferents matrius de transformació geomètrica TG
    ...
    // MortyPortalTest - Mètode que es pot fer servir per veure si el Morty està molt a prop del Portal (només comprova distàncies entre posMorty i la posició portal calculada a partir de l'angle que té en Rick quan obre el portal angleRick).
